...
//         // std::cout << "CODE 运行到这里了 cut_The_PointCloud 1 " << std::endl;
//         // Cut the point cloud here
//         // check the mapper empty or not
//         Eigen::Vector3d target_Point, hori_vec;
//         // std::cout << "CODE 运行到这里了 cut_The_PointCloud 2 " << std::endl;
//         if (mapper->surface != NULL && !(mapper->surface->empty()))
//         {
//             // std::cout << "CODE 运行到这里了 cut_The_PointCloud 3 " << std::endl;
//             // std::cout << "-------------------- Try to cut the pointcloud --------------------" << std::endl;
//             Eigen::Vector3d copy_curr_Pwc;
//             copy_curr_Pwc << currPwc[0], currPwc[1], currPwc[2];
...
//             // set the value of min and max point of the box
...
//             // calculate the abstract plane
//             Eigen::Vector3d plane_norm = hori_vec.cross(gravity_vec);      //得到速度平面

//             // filter with distance and project to the plane
...
//             cv::Mat vis_img = cv::Mat::zeros(cv::Size(180, 180), CV_8UC3);
...
//                                     plane_norm,
//                                     vec_color_key,
//                                     shared_data_back.map_planes,  // 更新后台
//                                     map_planes_in_pointclouds,
//                                     img_resolu,
//                                     vis_img,
//                                     hori_vec);
...
//             // cv::imwrite("/home/lfc/lfc/lfc_exoskeleton/v4/VisualSystem100HzFromShunyi-main/Code/visu_proj.png", vis_img);
//             // cv::waitKey(10);
//             cv::waitKey(1);

//             // c_comp::fit_3D_plane(vec_color_key,
//             //                      map_planes_in_pointclouds,
//             //                      eff_vec_color_key);      //eff_vec_color_key cal线程里面用到了 
//             // thread_mutex_2.unlock();

//             //  改双缓存  === 修改点2：更新后台缓冲区 ===
//             c_comp::fit_3D_plane(vec_color_key,
//                                 map_planes_in_pointclouds,
//                                 shared_data_back.eff_vec_color_key); // 更新后台
...
//             /*
//             thread_mutex_2  线程上锁， 在更新的时候会存在停滞
//             @todo
...
//                 // viewer->setShapeRenderingProperties(pcl::visualization::PCL_VISUALIZER_FONT_SIZE, 8, "velocity_vector");
//             }
//             else
//             {
//                 continue;
