...
float VOXEL_SIZE, MAX_DEPTH, MIN_DEPTH;
cv::Mat K;
...
void readParameters(ros::NodeHandle &n)
{
    ...
    GRAVITY = fsSettings["g_norm"];
    G.z() = fsSettings["g_norm"];
    ROW = fsSettings["image_height"];
    COL = fsSettings["image_width"];
    ROS_INFO("ROW: %f COL: %f ", ROW, COL);

    GRID_DIM_X = fsSettings["grid_dim_x"];
    GRID_DIM_Y = fsSettings["grid_dim_y"];
    GRID_DIM_Z = fsSettings["grid_dim_z"];
