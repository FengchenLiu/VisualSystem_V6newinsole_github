#include <stdio.h>
#include <ros/ros.h>
#include "scene_graph/NormalModel.h"
...
void test(){
    ...
    bool rampExtractionResult = ramp1.extractFromPlanes(rpTestDetectedPlanes, 0);
    ...
    lgRamp1.extractFromPlanes(vecLevelGroundPlanes, 1);
