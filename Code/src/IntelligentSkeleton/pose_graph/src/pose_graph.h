...
#include "utility/tic_toc.h"
#include "loop_closure/DBoW/DBoW2.h"
#include "loop_closure/DVision/DVision.h"
#include "loop_closure/DBoW/TemplatedDatabase.h"
#include "loop_closure/DBoW/TemplatedVocabulary.h"
...
public:
	...
	void addKeyFrame(KeyFrame* cur_kf, cv::Mat& colormap, cv::Mat& depthmap, bool flag_detect_loop);
	void loadKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop);
	void loadFusionParam(int h, int w, double fx, double fy, double cx, double cy, double max_depth, double min_depth);
